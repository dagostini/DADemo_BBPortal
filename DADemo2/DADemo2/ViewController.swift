...
class ViewController: UIViewController {
    ...
    private var progressPortal: BBPortalProtocol?
    ...
    private func setupProgressPortal() {
        progressPortal = BBPortal(withGroupIdentifier: Constants.GroupID, andPortalID: Constants.SliderPortalID)
        progressPortal?.onDataAvailable = {
            (data) in
